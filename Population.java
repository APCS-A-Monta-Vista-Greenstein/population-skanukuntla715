...
public class Population {
	...
	public static void main(String[]args){
		...
		//while(!finished) {
			if (choice == 1) {
				...
				printCities(sortByPopulationAscending(loadCities("usPopData2017.txt")));
			} else if (choice == 2) {
				System.out.println("\nFifty most populous cities\n");
				printCities(sortByPopulationDescending(loadCities("usPopData2017.txt")));
			} else if (choice == 3) {
				System.out.println("\nFifty cities sorted by name\n");
				printCities(sortByNameAscending(loadCities("usPopData2017.txt")));
			} else if (choice == 4) {
				System.out.println("\nFifty cities sorted by name descending\n");
				printCities(sortByNameDescending(loadCities("usPopData2017.txt")));
			} else if (choice == 5) {
				System.out.print("Enter state name (ie. Alabama) -> ");
				String askState = scan.next();
				System.out.println("Most populous cities in " + askState);
				printCities(mostPopulousCitiesInState(loadCities("usPopData2017.txt"), askState));
			} else if (choice == 6) {
				System.out.print("Enter city name -> ");
				String askCity = scan.next();
				System.out.println("City " + askCity + " by population");
				printCities(mostPopulousCitiesInState(loadCities("usPopData2017.txt"), askCity));
			} else {
				scan.close();
			}
	...
	/**
	 * Prints the 50 states, cities, and populations
	 *
